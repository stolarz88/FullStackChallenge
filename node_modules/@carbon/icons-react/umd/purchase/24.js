(function (global, factory) {
  ...
  (global.Purchase24 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function Purchase24({ children, ...rest }) {
    return React.createElement(
      ...
      React.createElement('path', { d: 'M6 20h10v2H6z' })
    );
  }

  Purchase24.displayName = 'Purchase24';
  Purchase24.propTypes = {
