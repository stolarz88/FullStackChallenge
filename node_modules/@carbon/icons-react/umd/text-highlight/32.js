(function (global, factory) {
  ...
  (global.TextHighlight32 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function TextHighlight32({ children, ...rest }) {
  ...
  TextHighlight32.displayName = 'TextHighlight32';
  TextHighlight32.propTypes = {
