(function (global, factory) {
  ...
  (global.TextHighlight20 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function TextHighlight20({ children, ...rest }) {
  ...
  TextHighlight20.displayName = 'TextHighlight20';
  TextHighlight20.propTypes = {
