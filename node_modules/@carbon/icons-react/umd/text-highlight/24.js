(function (global, factory) {
  ...
  (global.TextHighlight24 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function TextHighlight24({ children, ...rest }) {
  ...
  TextHighlight24.displayName = 'TextHighlight24';
  TextHighlight24.propTypes = {
