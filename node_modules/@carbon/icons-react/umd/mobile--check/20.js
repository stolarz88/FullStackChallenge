(function (global, factory) {
  ...
  (global.MobileCheck20 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function MobileCheck20({ children, ...rest }) {
    return React.createElement(
      ...
      React.createElement('path', {
        d: 'M14 18.18l-2.59-2.59L10 17l4 4 8-8-1.41-1.41L14 18.18z',
      })
    );
  }

  MobileCheck20.displayName = 'MobileCheck20';
  MobileCheck20.propTypes = {
