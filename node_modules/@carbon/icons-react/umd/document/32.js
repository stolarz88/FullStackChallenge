(function (global, factory) {
  ...
  (global.Document32 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function Document32({ children, ...rest }) {
    return React.createElement(
      ...
      React.createElement('path', { d: 'M11 22h10v2H11zm0-6h10v2H11z' })
    );
  }

  Document32.displayName = 'Document32';
  Document32.propTypes = {
