(function (global, factory) {
  ...
  (global.ChevronLeftGlyph = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function ChevronLeftGlyph({ children, ...rest }) {
  ...
  ChevronLeftGlyph.displayName = 'ChevronLeftGlyph';
  ChevronLeftGlyph.propTypes = {
