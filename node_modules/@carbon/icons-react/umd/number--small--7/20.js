(function (global, factory) {
  ...
  (global.NumberSmall_720 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function NumberSmall_720({ children, ...rest }) {
  ...
  NumberSmall_720.displayName = 'NumberSmall_720';
  NumberSmall_720.propTypes = {
