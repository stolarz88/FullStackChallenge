(function (global, factory) {
  ...
  (global.NumberSmall_732 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function NumberSmall_732({ children, ...rest }) {
  ...
  NumberSmall_732.displayName = 'NumberSmall_732';
  NumberSmall_732.propTypes = {
