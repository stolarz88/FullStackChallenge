(function (global, factory) {
  ...
  (global.Help16 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function Help16({ children, ...rest }) {
    return React.createElement(
      ...
      React.createElement('circle', { cx: '8', cy: '11.8', r: '.8' }),
      React.createElement('path', {
        d:
