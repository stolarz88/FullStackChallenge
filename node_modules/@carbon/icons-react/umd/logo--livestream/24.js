(function (global, factory) {
  ...
  (global.LogoLivestream24 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function LogoLivestream24({ children, ...rest }) {
  ...
  LogoLivestream24.displayName = 'LogoLivestream24';
  LogoLivestream24.propTypes = {
