(function (global, factory) {
  ...
  (global.LogoLivestream20 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function LogoLivestream20({ children, ...rest }) {
  ...
  LogoLivestream20.displayName = 'LogoLivestream20';
  LogoLivestream20.propTypes = {
