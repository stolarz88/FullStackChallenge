(function (global, factory) {
  ...
  (global.LogoLivestream32 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function LogoLivestream32({ children, ...rest }) {
  ...
  LogoLivestream32.displayName = 'LogoLivestream32';
  LogoLivestream32.propTypes = {
