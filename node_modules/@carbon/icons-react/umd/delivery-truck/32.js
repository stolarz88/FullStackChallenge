(function (global, factory) {
  ...
  (global.DeliveryTruck32 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function DeliveryTruck32({ children, ...rest }) {
  ...
  DeliveryTruck32.displayName = 'DeliveryTruck32';
  DeliveryTruck32.propTypes = {
