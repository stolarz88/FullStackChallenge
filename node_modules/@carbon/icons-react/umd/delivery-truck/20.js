(function (global, factory) {
  ...
  (global.DeliveryTruck20 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function DeliveryTruck20({ children, ...rest }) {
  ...
  DeliveryTruck20.displayName = 'DeliveryTruck20';
  DeliveryTruck20.propTypes = {
