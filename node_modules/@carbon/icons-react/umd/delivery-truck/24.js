(function (global, factory) {
  ...
  (global.DeliveryTruck24 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function DeliveryTruck24({ children, ...rest }) {
  ...
  DeliveryTruck24.displayName = 'DeliveryTruck24';
  DeliveryTruck24.propTypes = {
