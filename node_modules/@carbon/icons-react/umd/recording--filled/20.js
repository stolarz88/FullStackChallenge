(function (global, factory) {
  ...
  (global.RecordingFilled20 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function RecordingFilled20({ children, ...rest }) {
  ...
  RecordingFilled20.displayName = 'RecordingFilled20';
  RecordingFilled20.propTypes = {
  ...
  RecordingFilled20.defaultProps = {
    width: 20,
    height: 20,
    viewBox: '0 0 32 32',
