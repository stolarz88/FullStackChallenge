(function (global, factory) {
  ...
  (global.RecordingFilled32 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function RecordingFilled32({ children, ...rest }) {
  ...
  RecordingFilled32.displayName = 'RecordingFilled32';
  RecordingFilled32.propTypes = {
  ...
  RecordingFilled32.defaultProps = {
    width: 32,
    height: 32,
    viewBox: '0 0 32 32',
