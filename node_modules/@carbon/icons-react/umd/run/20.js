(function (global, factory) {
  ...
  (global.Run20 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function Run20({ children, ...rest }) {
    return React.createElement(
      ...
      React.createElement('path', { d: 'M19 19v6l5-3-5-3z' })
    );
  }

  Run20.displayName = 'Run20';
  Run20.propTypes = {
