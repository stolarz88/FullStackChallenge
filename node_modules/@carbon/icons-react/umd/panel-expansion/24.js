(function (global, factory) {
  ...
  (global.PanelExpansion24 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function PanelExpansion24({ children, ...rest }) {
  ...
  PanelExpansion24.displayName = 'PanelExpansion24';
  PanelExpansion24.propTypes = {
