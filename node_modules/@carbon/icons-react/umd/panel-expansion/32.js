(function (global, factory) {
  ...
  (global.PanelExpansion32 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function PanelExpansion32({ children, ...rest }) {
  ...
  PanelExpansion32.displayName = 'PanelExpansion32';
  PanelExpansion32.propTypes = {
