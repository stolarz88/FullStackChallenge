(function (global, factory) {
  ...
  (global.OverflowMenuHorizontal32 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function OverflowMenuHorizontal32({ children, ...rest }) {
    return React.createElement(
      ...
      React.createElement('circle', { cx: '26', cy: '16', r: '2' })
    );
  }

  OverflowMenuHorizontal32.displayName = 'OverflowMenuHorizontal32';
  OverflowMenuHorizontal32.propTypes = {
  ...
  OverflowMenuHorizontal32.defaultProps = {
    width: 32,
    height: 32,
    viewBox: '0 0 32 32',
