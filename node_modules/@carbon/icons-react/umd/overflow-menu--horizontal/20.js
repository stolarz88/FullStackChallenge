(function (global, factory) {
  ...
  (global.OverflowMenuHorizontal20 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function OverflowMenuHorizontal20({ children, ...rest }) {
  ...
  OverflowMenuHorizontal20.displayName = 'OverflowMenuHorizontal20';
  OverflowMenuHorizontal20.propTypes = {
  ...
  OverflowMenuHorizontal20.defaultProps = {
    width: 20,
    height: 20,
    viewBox: '0 0 32 32',
