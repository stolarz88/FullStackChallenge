(function (global, factory) {
  ...
  (global.MicrophoneOff20 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function MicrophoneOff20({ children, ...rest }) {
  ...
  MicrophoneOff20.displayName = 'MicrophoneOff20';
  MicrophoneOff20.propTypes = {
