(function (global, factory) {
  ...
  (global.MicrophoneOff24 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function MicrophoneOff24({ children, ...rest }) {
  ...
  MicrophoneOff24.displayName = 'MicrophoneOff24';
  MicrophoneOff24.propTypes = {
