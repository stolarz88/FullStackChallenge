(function (global, factory) {
  ...
  (global.DocumentTasks20 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function DocumentTasks20({ children, ...rest }) {
  ...
  DocumentTasks20.displayName = 'DocumentTasks20';
  DocumentTasks20.propTypes = {
