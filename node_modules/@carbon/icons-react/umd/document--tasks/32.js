(function (global, factory) {
  ...
  (global.DocumentTasks32 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function DocumentTasks32({ children, ...rest }) {
    return React.createElement(
      ...
      React.createElement('path', {
        d: 'M14 22.18l-2.59-2.59L10 21l4 4 8-8-1.41-1.41L14 22.18z',
      })
    );
  }

  DocumentTasks32.displayName = 'DocumentTasks32';
  DocumentTasks32.propTypes = {
