(function (global, factory) {
  ...
  (global.DocumentTasks24 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function DocumentTasks24({ children, ...rest }) {
  ...
  DocumentTasks24.displayName = 'DocumentTasks24';
  DocumentTasks24.propTypes = {
