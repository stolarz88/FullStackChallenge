(function (global, factory) {
  ...
  (global.LogoGooglePlus32 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function LogoGooglePlus32({ children, ...rest }) {
  ...
  LogoGooglePlus32.displayName = 'LogoGooglePlus32';
  LogoGooglePlus32.propTypes = {
