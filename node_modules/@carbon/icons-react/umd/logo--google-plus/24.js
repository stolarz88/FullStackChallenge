(function (global, factory) {
  ...
  (global.LogoGooglePlus24 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function LogoGooglePlus24({ children, ...rest }) {
  ...
  LogoGooglePlus24.displayName = 'LogoGooglePlus24';
  LogoGooglePlus24.propTypes = {
