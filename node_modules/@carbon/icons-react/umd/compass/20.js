(function (global, factory) {
  ...
  (global.Compass20 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function Compass20({ children, ...rest }) {
    return React.createElement(
      ...
      React.createElement('circle', { cx: '16', cy: '7.5', r: '1.5' })
    );
  }

  Compass20.displayName = 'Compass20';
  Compass20.propTypes = {
