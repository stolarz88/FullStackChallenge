(function (global, factory) {
  ...
  (global.FingerprintRecognition24 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function FingerprintRecognition24({ children, ...rest }) {
  ...
  FingerprintRecognition24.displayName = 'FingerprintRecognition24';
  FingerprintRecognition24.propTypes = {
  ...
  FingerprintRecognition24.defaultProps = {
    width: 24,
    height: 24,
    viewBox: '0 0 32 32',
