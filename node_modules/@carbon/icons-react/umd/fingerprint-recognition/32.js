(function (global, factory) {
  ...
  (global.FingerprintRecognition32 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function FingerprintRecognition32({ children, ...rest }) {
  ...
  FingerprintRecognition32.displayName = 'FingerprintRecognition32';
  FingerprintRecognition32.propTypes = {
  ...
  FingerprintRecognition32.defaultProps = {
    width: 32,
    height: 32,
    viewBox: '0 0 32 32',
