(function (global, factory) {
  ...
  (global.LogoPinterest20 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function LogoPinterest20({ children, ...rest }) {
  ...
  LogoPinterest20.displayName = 'LogoPinterest20';
  LogoPinterest20.propTypes = {
