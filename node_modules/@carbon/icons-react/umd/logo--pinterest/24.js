(function (global, factory) {
  ...
  (global.LogoPinterest24 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function LogoPinterest24({ children, ...rest }) {
  ...
  LogoPinterest24.displayName = 'LogoPinterest24';
  LogoPinterest24.propTypes = {
