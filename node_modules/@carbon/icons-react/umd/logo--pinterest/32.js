(function (global, factory) {
  ...
  (global.LogoPinterest32 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function LogoPinterest32({ children, ...rest }) {
  ...
  LogoPinterest32.displayName = 'LogoPinterest32';
  LogoPinterest32.propTypes = {
