(function (global, factory) {
  ...
  (global.RecentlyViewed20 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function RecentlyViewed20({ children, ...rest }) {
  ...
  RecentlyViewed20.displayName = 'RecentlyViewed20';
  RecentlyViewed20.propTypes = {
