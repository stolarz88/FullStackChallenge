(function (global, factory) {
  ...
  (global.RecentlyViewed24 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function RecentlyViewed24({ children, ...rest }) {
  ...
  RecentlyViewed24.displayName = 'RecentlyViewed24';
  RecentlyViewed24.propTypes = {
