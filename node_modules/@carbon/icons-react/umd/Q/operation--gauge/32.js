(function (global, factory) {
  ...
  (global.QOperationGauge32 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function QOperationGauge32({ children, ...rest }) {
  ...
  QOperationGauge32.displayName = 'QOperationGauge32';
  QOperationGauge32.propTypes = {
  ...
  QOperationGauge32.defaultProps = {
    width: 32,
    height: 32,
    viewBox: '0 0 32 32',
