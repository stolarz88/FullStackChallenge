(function (global, factory) {
  ...
  (global.QOperationGauge24 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function QOperationGauge24({ children, ...rest }) {
  ...
  QOperationGauge24.displayName = 'QOperationGauge24';
  QOperationGauge24.propTypes = {
  ...
  QOperationGauge24.defaultProps = {
    width: 24,
    height: 24,
    viewBox: '0 0 32 32',
