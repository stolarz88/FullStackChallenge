(function (global, factory) {
  ...
  (global.QOperationGauge20 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function QOperationGauge20({ children, ...rest }) {
  ...
  QOperationGauge20.displayName = 'QOperationGauge20';
  QOperationGauge20.propTypes = {
  ...
  QOperationGauge20.defaultProps = {
    width: 20,
    height: 20,
    viewBox: '0 0 32 32',
