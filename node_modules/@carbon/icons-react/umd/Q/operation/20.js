(function (global, factory) {
  ...
  (global.QOperation20 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function QOperation20({ children, ...rest }) {
    return React.createElement(
      ...
      React.createElement('path', { d: 'M13 15h2v2h-2z' })
    );
  }

  QOperation20.displayName = 'QOperation20';
  QOperation20.propTypes = {
