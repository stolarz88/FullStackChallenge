(function (global, factory) {
  ...
  (global.QBarrier20 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function QBarrier20({ children, ...rest }) {
    return React.createElement(
      ...
      React.createElement('path', {
        fill: '#171717',
        d: 'M15 5h2v4h-2zm0 6h2v4h-2zm0 6h2v4h-2zm0 6h2v4h-2z',
      })
    );
  }

  QBarrier20.displayName = 'QBarrier20';
  QBarrier20.propTypes = {
