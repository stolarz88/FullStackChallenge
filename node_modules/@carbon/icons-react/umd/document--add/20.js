(function (global, factory) {
  ...
  (global.DocumentAdd20 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function DocumentAdd20({ children, ...rest }) {
    return React.createElement(
      ...
      React.createElement('path', { d: 'M21 19h-4v-4h-2v4h-4v2h4v4h2v-4h4v-2z' })
    );
  }

  DocumentAdd20.displayName = 'DocumentAdd20';
  DocumentAdd20.propTypes = {
