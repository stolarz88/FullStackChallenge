(function (global, factory) {
  ...
  (global.FaceActivated32 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function FaceActivated32({ children, ...rest }) {
  ...
  FaceActivated32.displayName = 'FaceActivated32';
  FaceActivated32.propTypes = {
