(function (global, factory) {
  ...
  (global.FaceActivated20 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function FaceActivated20({ children, ...rest }) {
  ...
  FaceActivated20.displayName = 'FaceActivated20';
  FaceActivated20.propTypes = {
