(function (global, factory) {
  ...
  (global.FaceActivated24 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function FaceActivated24({ children, ...rest }) {
  ...
  FaceActivated24.displayName = 'FaceActivated24';
  FaceActivated24.propTypes = {
