(function (global, factory) {
  ...
  (global.RecordingFilledAlt32 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function RecordingFilledAlt32({ children, ...rest }) {
  ...
  RecordingFilledAlt32.displayName = 'RecordingFilledAlt32';
  RecordingFilledAlt32.propTypes = {
  ...
  RecordingFilledAlt32.defaultProps = {
    width: 32,
    height: 32,
    viewBox: '0 0 32 32',
