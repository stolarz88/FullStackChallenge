(function (global, factory) {
  ...
  (global.RecordingFilledAlt20 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function RecordingFilledAlt20({ children, ...rest }) {
  ...
  RecordingFilledAlt20.displayName = 'RecordingFilledAlt20';
  RecordingFilledAlt20.propTypes = {
  ...
  RecordingFilledAlt20.defaultProps = {
    width: 20,
    height: 20,
    viewBox: '0 0 32 32',
