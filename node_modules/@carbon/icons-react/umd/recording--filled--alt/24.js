(function (global, factory) {
  ...
  (global.RecordingFilledAlt24 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function RecordingFilledAlt24({ children, ...rest }) {
  ...
  RecordingFilledAlt24.displayName = 'RecordingFilledAlt24';
  RecordingFilledAlt24.propTypes = {
  ...
  RecordingFilledAlt24.defaultProps = {
    width: 24,
    height: 24,
    viewBox: '0 0 32 32',
