(function (global, factory) {
  ...
  (global.LogoStumbleupon24 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function LogoStumbleupon24({ children, ...rest }) {
  ...
  LogoStumbleupon24.displayName = 'LogoStumbleupon24';
  LogoStumbleupon24.propTypes = {
  ...
  LogoStumbleupon24.defaultProps = {
    width: 24,
    height: 24,
    viewBox: '0 0 32 32',
