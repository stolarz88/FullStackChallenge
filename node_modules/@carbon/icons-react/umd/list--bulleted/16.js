(function (global, factory) {
  ...
  (global.ListBulleted16 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function ListBulleted16({ children, ...rest }) {
    return React.createElement(
      'svg',
      iconHelpers.getAttributes(rest),
      children,
      React.createElement('circle', { cx: '3.5', cy: '4.5', r: '1.5' }),
      React.createElement('circle', { cx: '3.5', cy: '11.5', r: '1.5' }),
      React.createElement('path', { d: 'M8 11h7v1H8zm0-7h7v1H8z' })
    );
  }
