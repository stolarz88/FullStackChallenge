(function (global, factory) {
  ...
  (global.LetterCc32 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function LetterCc32({ children, ...rest }) {
    return React.createElement(
      ...
      React.createElement('path', {
        d:
          'M24 23h-5a2 2 0 0 1-2-2v-6a2 2 0 0 1 2-2h5v2h-5v6h5zm-9 0h-5a2 2 0 0 1-2-2V11a2 2 0 0 1 2-2h5v2h-5v10h5z',
      })
    );
  }

  LetterCc32.displayName = 'LetterCc32';
  LetterCc32.propTypes = {
