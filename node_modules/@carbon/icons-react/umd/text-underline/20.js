(function (global, factory) {
  ...
  (global.TextUnderline20 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function TextUnderline20({ children, ...rest }) {
  ...
  TextUnderline20.displayName = 'TextUnderline20';
  TextUnderline20.propTypes = {
