(function (global, factory) {
  ...
  (global.TextUnderline24 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function TextUnderline24({ children, ...rest }) {
  ...
  TextUnderline24.displayName = 'TextUnderline24';
  TextUnderline24.propTypes = {
