(function (global, factory) {
  ...
  (global.NotificationOff32 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function NotificationOff32({ children, ...rest }) {
  ...
  NotificationOff32.displayName = 'NotificationOff32';
  NotificationOff32.propTypes = {
  ...
  NotificationOff32.defaultProps = {
    width: 32,
    height: 32,
    viewBox: '0 0 32 32',
