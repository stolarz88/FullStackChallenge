(function (global, factory) {
  ...
  (global.NotificationOff24 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function NotificationOff24({ children, ...rest }) {
  ...
  NotificationOff24.displayName = 'NotificationOff24';
  NotificationOff24.propTypes = {
  ...
  NotificationOff24.defaultProps = {
    width: 24,
    height: 24,
    viewBox: '0 0 32 32',
