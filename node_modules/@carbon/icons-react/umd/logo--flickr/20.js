(function (global, factory) {
  ...
  (global.LogoFlickr20 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function LogoFlickr20({ children, ...rest }) {
    return React.createElement(
      'svg',
      iconHelpers.getAttributes(rest),
      children,
      React.createElement('circle', { cx: '8', cy: '16', r: '6' }),
      React.createElement('circle', { cx: '24', cy: '16', r: '6' })
    );
  }

  LogoFlickr20.displayName = 'LogoFlickr20';
  LogoFlickr20.propTypes = {
