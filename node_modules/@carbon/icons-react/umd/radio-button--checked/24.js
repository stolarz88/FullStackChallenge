(function (global, factory) {
  ...
  (global.RadioButtonChecked24 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function RadioButtonChecked24({ children, ...rest }) {
    return React.createElement(
      ...
      React.createElement('path', { d: 'M16 10a6 6 0 1 0 6 6 6 6 0 0 0-6-6z' })
    );
  }

  RadioButtonChecked24.displayName = 'RadioButtonChecked24';
  RadioButtonChecked24.propTypes = {
  ...
  RadioButtonChecked24.defaultProps = {
    width: 24,
    height: 24,
    viewBox: '0 0 32 32',
