(function (global, factory) {
  ...
  (global.RadioButtonChecked20 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function RadioButtonChecked20({ children, ...rest }) {
  ...
  RadioButtonChecked20.displayName = 'RadioButtonChecked20';
  RadioButtonChecked20.propTypes = {
  ...
  RadioButtonChecked20.defaultProps = {
    width: 20,
    height: 20,
    viewBox: '0 0 32 32',
