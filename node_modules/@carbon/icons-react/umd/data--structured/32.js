(function (global, factory) {
  ...
  (global.DataStructured32 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function DataStructured32({ children, ...rest }) {
    return React.createElement(
      'svg',
      iconHelpers.getAttributes(rest),
      children,
      React.createElement('circle', { cx: '9', cy: '7', r: '1' }),
  ...
  DataStructured32.displayName = 'DataStructured32';
  DataStructured32.propTypes = {
