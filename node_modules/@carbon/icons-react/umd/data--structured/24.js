(function (global, factory) {
  ...
  (global.DataStructured24 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function DataStructured24({ children, ...rest }) {
  ...
  DataStructured24.displayName = 'DataStructured24';
  DataStructured24.propTypes = {
