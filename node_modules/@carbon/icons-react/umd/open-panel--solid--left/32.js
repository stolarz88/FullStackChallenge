(function (global, factory) {
  ...
  (global.OpenPanelSolidLeft32 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function OpenPanelSolidLeft32({ children, ...rest }) {
  ...
  OpenPanelSolidLeft32.displayName = 'OpenPanelSolidLeft32';
  OpenPanelSolidLeft32.propTypes = {
  ...
  OpenPanelSolidLeft32.defaultProps = {
    width: 32,
    height: 32,
    viewBox: '0 0 32 32',
