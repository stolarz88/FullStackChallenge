(function (global, factory) {
  ...
  (global.OpenPanelSolidLeft20 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function OpenPanelSolidLeft20({ children, ...rest }) {
  ...
  OpenPanelSolidLeft20.displayName = 'OpenPanelSolidLeft20';
  OpenPanelSolidLeft20.propTypes = {
  ...
  OpenPanelSolidLeft20.defaultProps = {
    width: 20,
    height: 20,
    viewBox: '0 0 32 32',
