(function (global, factory) {
  ...
  (global.SubtractAlt24 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function SubtractAlt24({ children, ...rest }) {
    return React.createElement(
      ...
      React.createElement('path', { d: 'M10 15h12v2H10z' })
    );
  }

  SubtractAlt24.displayName = 'SubtractAlt24';
  SubtractAlt24.propTypes = {
