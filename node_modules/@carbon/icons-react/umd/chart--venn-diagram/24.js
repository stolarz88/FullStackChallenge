(function (global, factory) {
  ...
  (global.ChartVennDiagram24 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function ChartVennDiagram24({ children, ...rest }) {
  ...
  ChartVennDiagram24.displayName = 'ChartVennDiagram24';
  ChartVennDiagram24.propTypes = {
  ...
  ChartVennDiagram24.defaultProps = {
    width: 24,
    height: 24,
    viewBox: '0 0 32 32',
