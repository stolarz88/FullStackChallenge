(function (global, factory) {
  ...
  (global.ChartVennDiagram32 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function ChartVennDiagram32({ children, ...rest }) {
  ...
  ChartVennDiagram32.displayName = 'ChartVennDiagram32';
  ChartVennDiagram32.propTypes = {
  ...
  ChartVennDiagram32.defaultProps = {
    width: 32,
    height: 32,
    viewBox: '0 0 32 32',
