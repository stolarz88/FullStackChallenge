(function (global, factory) {
  ...
  (global.FaceDizzyFilled20 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function FaceDizzyFilled20({ children, ...rest }) {
  ...
  FaceDizzyFilled20.displayName = 'FaceDizzyFilled20';
  FaceDizzyFilled20.propTypes = {
  ...
  FaceDizzyFilled20.defaultProps = {
    width: 20,
    height: 20,
    viewBox: '0 0 32 32',
