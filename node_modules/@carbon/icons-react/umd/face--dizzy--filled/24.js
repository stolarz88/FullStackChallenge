(function (global, factory) {
  ...
  (global.FaceDizzyFilled24 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function FaceDizzyFilled24({ children, ...rest }) {
  ...
  FaceDizzyFilled24.displayName = 'FaceDizzyFilled24';
  FaceDizzyFilled24.propTypes = {
  ...
  FaceDizzyFilled24.defaultProps = {
    width: 24,
    height: 24,
    viewBox: '0 0 32 32',
