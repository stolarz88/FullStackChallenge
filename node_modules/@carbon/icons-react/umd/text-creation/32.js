(function (global, factory) {
  ...
  (global.TextCreation32 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function TextCreation32({ children, ...rest }) {
    return React.createElement(
      ...
      React.createElement('path', { d: 'M21 11H11v2h4v9h2v-9h4v-2z' })
    );
  }

  TextCreation32.displayName = 'TextCreation32';
  TextCreation32.propTypes = {
