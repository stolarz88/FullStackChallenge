(function (global, factory) {
  ...
  (global.TableOfContents32 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function TableOfContents32({ children, ...rest }) {
  ...
  TableOfContents32.displayName = 'TableOfContents32';
  TableOfContents32.propTypes = {
  ...
  TableOfContents32.defaultProps = {
    width: 32,
    height: 32,
    viewBox: '0 0 32 32',
