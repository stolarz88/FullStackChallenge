(function (global, factory) {
  ...
  (global.TableOfContents20 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function TableOfContents20({ children, ...rest }) {
  ...
  TableOfContents20.displayName = 'TableOfContents20';
  TableOfContents20.propTypes = {
  ...
  TableOfContents20.defaultProps = {
    width: 20,
    height: 20,
    viewBox: '0 0 32 32',
