(function (global, factory) {
  ...
  (global.TableOfContents24 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function TableOfContents24({ children, ...rest }) {
  ...
  TableOfContents24.displayName = 'TableOfContents24';
  TableOfContents24.propTypes = {
  ...
  TableOfContents24.defaultProps = {
    width: 24,
    height: 24,
    viewBox: '0 0 32 32',
