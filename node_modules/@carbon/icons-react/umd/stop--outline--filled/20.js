(function (global, factory) {
  ...
  (global.StopOutlineFilled20 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function StopOutlineFilled20({ children, ...rest }) {
  ...
  StopOutlineFilled20.displayName = 'StopOutlineFilled20';
  StopOutlineFilled20.propTypes = {
  ...
  StopOutlineFilled20.defaultProps = {
    width: 20,
    height: 20,
    viewBox: '0 0 32 32',
