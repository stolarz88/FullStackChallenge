(function (global, factory) {
  ...
  (global.StopOutlineFilled24 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function StopOutlineFilled24({ children, ...rest }) {
  ...
  StopOutlineFilled24.displayName = 'StopOutlineFilled24';
  StopOutlineFilled24.propTypes = {
  ...
  StopOutlineFilled24.defaultProps = {
    width: 24,
    height: 24,
    viewBox: '0 0 32 32',
