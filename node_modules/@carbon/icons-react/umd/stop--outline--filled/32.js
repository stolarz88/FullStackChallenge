(function (global, factory) {
  ...
  (global.StopOutlineFilled32 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function StopOutlineFilled32({ children, ...rest }) {
    return React.createElement(
      ...
      React.createElement('path', { d: 'M12 12h8v8h-8z' })
    );
  }

  StopOutlineFilled32.displayName = 'StopOutlineFilled32';
  StopOutlineFilled32.propTypes = {
  ...
  StopOutlineFilled32.defaultProps = {
    width: 32,
    height: 32,
    viewBox: '0 0 32 32',
