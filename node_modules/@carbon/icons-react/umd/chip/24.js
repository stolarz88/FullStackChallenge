(function (global, factory) {
  ...
  (global.Chip24 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function Chip24({ children, ...rest }) {
    return React.createElement(
      ...
      React.createElement('path', {
        d:
          'M29 13v-2h-3V8a2 2 0 0 0-2-2h-3V3h-2v3h-6V3h-2v3H8a2 2 0 0 0-2 2v3H3v2h3v6H3v2h3v3a2 2 0 0 0 2 2h3v3h2v-3h6v3h2v-3h3a2 2 0 0 0 2-2v-3h3v-2h-3v-6zm-5 11H8V8h16z',
      })
    );
  }

  Chip24.displayName = 'Chip24';
  Chip24.propTypes = {
