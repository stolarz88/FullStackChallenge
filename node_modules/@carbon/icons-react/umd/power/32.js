(function (global, factory) {
  ...
  (global.Power32 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function Power32({ children, ...rest }) {
    return React.createElement(
      ...
      React.createElement('path', { d: 'M15 2h2v14h-2z' })
    );
  }

  Power32.displayName = 'Power32';
  Power32.propTypes = {
