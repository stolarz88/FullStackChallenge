(function (global, factory) {
  ...
  (global.ArrowUpRight24 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function ArrowUpRight24({ children, ...rest }) {
    return React.createElement(
      'svg',
      iconHelpers.getAttributes(rest),
      children,
      React.createElement('path', {
        d: 'M10 6v2h12.59L6 24.59 7.41 26 24 9.41V22h2V6H10z',
      })
    );
  }

  ArrowUpRight24.displayName = 'ArrowUpRight24';
  ArrowUpRight24.propTypes = {
