(function (global, factory) {
  ...
  (global.OverflowMenuVertical32 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function OverflowMenuVertical32({ children, ...rest }) {
    return React.createElement(
      ...
      React.createElement('circle', { cx: '16', cy: '26', r: '2' })
    );
  }

  OverflowMenuVertical32.displayName = 'OverflowMenuVertical32';
  OverflowMenuVertical32.propTypes = {
  ...
  OverflowMenuVertical32.defaultProps = {
    width: 32,
    height: 32,
    viewBox: '0 0 32 32',
