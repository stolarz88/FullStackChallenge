(function (global, factory) {
  ...
  (global.CheckboxChecked32 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function CheckboxChecked32({ children, ...rest }) {
  ...
  CheckboxChecked32.displayName = 'CheckboxChecked32';
  CheckboxChecked32.propTypes = {
  ...
  CheckboxChecked32.defaultProps = {
    width: 32,
    height: 32,
    viewBox: '0 0 32 32',
