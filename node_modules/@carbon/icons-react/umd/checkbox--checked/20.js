(function (global, factory) {
  ...
  (global.CheckboxChecked20 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function CheckboxChecked20({ children, ...rest }) {
  ...
  CheckboxChecked20.displayName = 'CheckboxChecked20';
  CheckboxChecked20.propTypes = {
  ...
  CheckboxChecked20.defaultProps = {
    width: 20,
    height: 20,
    viewBox: '0 0 32 32',
