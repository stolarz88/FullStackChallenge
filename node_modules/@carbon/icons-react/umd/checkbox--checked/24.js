(function (global, factory) {
  ...
  (global.CheckboxChecked24 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function CheckboxChecked24({ children, ...rest }) {
  ...
  CheckboxChecked24.displayName = 'CheckboxChecked24';
  CheckboxChecked24.propTypes = {
  ...
  CheckboxChecked24.defaultProps = {
    width: 24,
    height: 24,
    viewBox: '0 0 32 32',
