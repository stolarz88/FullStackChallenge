(function (global, factory) {
  ...
  (global.ErrorFilled32 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function ErrorFilled32({ children, ...rest }) {
    return React.createElement(
      ...
      React.createElement('path', {
        d:
          'M16 2a14 14 0 1 0 14 14A14 14 0 0 0 16 2zm5.41 21L9 10.59 10.59 9 23 21.41z',
      })
    );
  }

  ErrorFilled32.displayName = 'ErrorFilled32';
  ErrorFilled32.propTypes = {
