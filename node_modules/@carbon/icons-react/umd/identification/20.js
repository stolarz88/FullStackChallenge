(function (global, factory) {
  ...
  (global.Identification20 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function Identification20({ children, ...rest }) {
  ...
  Identification20.displayName = 'Identification20';
  Identification20.propTypes = {
