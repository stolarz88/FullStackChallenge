(function (global, factory) {
  ...
  (global.Number_132 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function Number_132({ children, ...rest }) {
    return React.createElement(
      ...
      React.createElement('path', {
        fill: '#fff',
        d: 'M12.5 22.5v-1h3v-11h-3v-1h4v12h3v1h-7z',
      }),
      React.createElement('path', {
        d: 'M16 10v12-12m1-1h-5v2h3v10h-3v2h8v-2h-3V9z',
      })
    );
  }

  Number_132.displayName = 'Number_132';
  Number_132.propTypes = {
