(function (global, factory) {
  ...
  (global.DocumentSubtract32 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function DocumentSubtract32({ children, ...rest }) {
  ...
  DocumentSubtract32.displayName = 'DocumentSubtract32';
  DocumentSubtract32.propTypes = {
  ...
  DocumentSubtract32.defaultProps = {
    width: 32,
    height: 32,
    viewBox: '0 0 32 32',
