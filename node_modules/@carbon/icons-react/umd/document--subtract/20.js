(function (global, factory) {
  ...
  (global.DocumentSubtract20 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function DocumentSubtract20({ children, ...rest }) {
  ...
  DocumentSubtract20.displayName = 'DocumentSubtract20';
  DocumentSubtract20.propTypes = {
  ...
  DocumentSubtract20.defaultProps = {
    width: 20,
    height: 20,
    viewBox: '0 0 32 32',
