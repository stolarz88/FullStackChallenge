(function (global, factory) {
  ...
  (global.DocumentSubtract24 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function DocumentSubtract24({ children, ...rest }) {
    return React.createElement(
      ...
      React.createElement('path', { d: 'M11 19h10v2H11z' })
    );
  }

  DocumentSubtract24.displayName = 'DocumentSubtract24';
  DocumentSubtract24.propTypes = {
  ...
  DocumentSubtract24.defaultProps = {
    width: 24,
    height: 24,
    viewBox: '0 0 32 32',
