(function (global, factory) {
  ...
  (global.MobileDownload32 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function MobileDownload32({ children, ...rest }) {
  ...
  MobileDownload32.displayName = 'MobileDownload32';
  MobileDownload32.propTypes = {
