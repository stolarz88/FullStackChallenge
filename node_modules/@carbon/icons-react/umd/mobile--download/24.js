(function (global, factory) {
  ...
  (global.MobileDownload24 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function MobileDownload24({ children, ...rest }) {
  ...
  MobileDownload24.displayName = 'MobileDownload24';
  MobileDownload24.propTypes = {
