(function (global, factory) {
  ...
  (global.MobileDownload20 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function MobileDownload20({ children, ...rest }) {
  ...
  MobileDownload20.displayName = 'MobileDownload20';
  MobileDownload20.propTypes = {
