(function (global, factory) {
  ...
  (global.Number_432 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function Number_432({ children, ...rest }) {
    return React.createElement(
      ...
      React.createElement('path', {
        fill: '#fff',
        d: 'M17.5 22.5v-4h-5v-9h1v8h4v-8h1v8h1v1h-1v4h-1z',
      }),
      React.createElement('path', {
  ...
  Number_432.displayName = 'Number_432';
  Number_432.propTypes = {
