(function (global, factory) {
  ...
  (global.EventSchedule24 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function EventSchedule24({ children, ...rest }) {
  ...
  EventSchedule24.displayName = 'EventSchedule24';
  EventSchedule24.propTypes = {
