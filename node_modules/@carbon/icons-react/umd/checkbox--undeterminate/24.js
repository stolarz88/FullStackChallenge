(function (global, factory) {
  ...
  (global.CheckboxUndeterminate24 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function CheckboxUndeterminate24({ children, ...rest }) {
    return React.createElement(
      'svg',
      iconHelpers.getAttributes(rest),
      children,
      React.createElement('path', { d: 'M10 14h12v4H10z' }),
  ...
  CheckboxUndeterminate24.displayName = 'CheckboxUndeterminate24';
  CheckboxUndeterminate24.propTypes = {
  ...
  CheckboxUndeterminate24.defaultProps = {
    width: 24,
    height: 24,
    viewBox: '0 0 32 32',
