(function (global, factory) {
  ...
  (global.CheckboxUndeterminate32 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function CheckboxUndeterminate32({ children, ...rest }) {
  ...
  CheckboxUndeterminate32.displayName = 'CheckboxUndeterminate32';
  CheckboxUndeterminate32.propTypes = {
  ...
  CheckboxUndeterminate32.defaultProps = {
    width: 32,
    height: 32,
    viewBox: '0 0 32 32',
