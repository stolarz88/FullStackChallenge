(function (global, factory) {
  ...
  (global.CheckboxUndeterminate20 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function CheckboxUndeterminate20({ children, ...rest }) {
  ...
  CheckboxUndeterminate20.displayName = 'CheckboxUndeterminate20';
  CheckboxUndeterminate20.propTypes = {
  ...
  CheckboxUndeterminate20.defaultProps = {
    width: 20,
    height: 20,
    viewBox: '0 0 32 32',
