(function (global, factory) {
  ...
  (global.MisuseOutline16 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function MisuseOutline16({ children, ...rest }) {
  ...
  MisuseOutline16.displayName = 'MisuseOutline16';
  MisuseOutline16.propTypes = {
