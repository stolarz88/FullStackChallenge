(function (global, factory) {
  ...
  (global.IndentMore20 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function IndentMore20({ children, ...rest }) {
  ...
  IndentMore20.displayName = 'IndentMore20';
  IndentMore20.propTypes = {
