(function (global, factory) {
  ...
  (global.IndentMore32 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function IndentMore32({ children, ...rest }) {
  ...
  IndentMore32.displayName = 'IndentMore32';
  IndentMore32.propTypes = {
