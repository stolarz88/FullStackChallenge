(function (global, factory) {
  ...
  (global.IndentMore24 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function IndentMore24({ children, ...rest }) {
  ...
  IndentMore24.displayName = 'IndentMore24';
  IndentMore24.propTypes = {
