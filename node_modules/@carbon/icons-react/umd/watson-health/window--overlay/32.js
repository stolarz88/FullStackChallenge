(function (global, factory) {
  ...
  (global.WatsonHealthWindowOverlay32 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function WatsonHealthWindowOverlay32({ children, ...rest }) {
  ...
  WatsonHealthWindowOverlay32.displayName = 'WatsonHealthWindowOverlay32';
  WatsonHealthWindowOverlay32.propTypes = {
  ...
  WatsonHealthWindowOverlay32.defaultProps = {
    width: 32,
    height: 32,
    viewBox: '0 0 32 32',
