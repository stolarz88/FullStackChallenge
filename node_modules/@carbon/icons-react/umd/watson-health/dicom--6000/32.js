(function (global, factory) {
  ...
  (global.WatsonHealthDicom_600032 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function WatsonHealthDicom_600032({ children, ...rest }) {
  ...
  WatsonHealthDicom_600032.displayName = 'WatsonHealthDicom_600032';
  WatsonHealthDicom_600032.propTypes = {
  ...
  WatsonHealthDicom_600032.defaultProps = {
    width: 32,
    height: 32,
    viewBox: '0 0 32 32',
