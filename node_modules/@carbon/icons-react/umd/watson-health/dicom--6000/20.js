(function (global, factory) {
  ...
  (global.WatsonHealthDicom_600020 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function WatsonHealthDicom_600020({ children, ...rest }) {
  ...
  WatsonHealthDicom_600020.displayName = 'WatsonHealthDicom_600020';
  WatsonHealthDicom_600020.propTypes = {
  ...
  WatsonHealthDicom_600020.defaultProps = {
    width: 20,
    height: 20,
    viewBox: '0 0 32 32',
