(function (global, factory) {
  ...
  (global.WatsonHealthDicomOverlay24 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function WatsonHealthDicomOverlay24({ children, ...rest }) {
    return React.createElement(
      ...
      React.createElement('path', { d: 'M6 8h10v2H6zm0 4h10v2H6zm0 4h6v2H6z' })
    );
  }

  WatsonHealthDicomOverlay24.displayName = 'WatsonHealthDicomOverlay24';
  WatsonHealthDicomOverlay24.propTypes = {
  ...
  WatsonHealthDicomOverlay24.defaultProps = {
    width: 24,
    height: 24,
    viewBox: '0 0 32 32',
