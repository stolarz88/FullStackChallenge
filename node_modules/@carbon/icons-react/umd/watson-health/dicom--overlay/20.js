(function (global, factory) {
  ...
  (global.WatsonHealthDicomOverlay20 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function WatsonHealthDicomOverlay20({ children, ...rest }) {
  ...
  WatsonHealthDicomOverlay20.displayName = 'WatsonHealthDicomOverlay20';
  WatsonHealthDicomOverlay20.propTypes = {
  ...
  WatsonHealthDicomOverlay20.defaultProps = {
    width: 20,
    height: 20,
    viewBox: '0 0 32 32',
