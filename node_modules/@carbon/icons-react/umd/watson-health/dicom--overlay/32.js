(function (global, factory) {
  ...
  (global.WatsonHealthDicomOverlay32 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function WatsonHealthDicomOverlay32({ children, ...rest }) {
  ...
  WatsonHealthDicomOverlay32.displayName = 'WatsonHealthDicomOverlay32';
  WatsonHealthDicomOverlay32.propTypes = {
  ...
  WatsonHealthDicomOverlay32.defaultProps = {
    width: 32,
    height: 32,
    viewBox: '0 0 32 32',
