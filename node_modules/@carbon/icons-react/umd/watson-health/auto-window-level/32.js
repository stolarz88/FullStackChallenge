(function (global, factory) {
  ...
  (global.WatsonHealthAutoWindowLevel32 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function WatsonHealthAutoWindowLevel32({ children, ...rest }) {
  ...
  WatsonHealthAutoWindowLevel32.displayName = 'WatsonHealthAutoWindowLevel32';
  WatsonHealthAutoWindowLevel32.propTypes = {
  ...
  WatsonHealthAutoWindowLevel32.defaultProps = {
    width: 32,
    height: 32,
    viewBox: '0 0 32 32',
  ...
  return WatsonHealthAutoWindowLevel32;
