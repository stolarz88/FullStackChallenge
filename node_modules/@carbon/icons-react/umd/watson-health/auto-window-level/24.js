(function (global, factory) {
  ...
  (global.WatsonHealthAutoWindowLevel24 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function WatsonHealthAutoWindowLevel24({ children, ...rest }) {
  ...
  WatsonHealthAutoWindowLevel24.displayName = 'WatsonHealthAutoWindowLevel24';
  WatsonHealthAutoWindowLevel24.propTypes = {
  ...
  WatsonHealthAutoWindowLevel24.defaultProps = {
    width: 24,
    height: 24,
    viewBox: '0 0 32 32',
  ...
  return WatsonHealthAutoWindowLevel24;
