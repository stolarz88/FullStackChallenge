(function (global, factory) {
  ...
  (global.WatsonHealthCobbAngle24 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function WatsonHealthCobbAngle24({ children, ...rest }) {
  ...
  WatsonHealthCobbAngle24.displayName = 'WatsonHealthCobbAngle24';
  WatsonHealthCobbAngle24.propTypes = {
  ...
  WatsonHealthCobbAngle24.defaultProps = {
    width: 24,
    height: 24,
    viewBox: '0 0 32 32',
