(function (global, factory) {
  ...
  (global.WatsonHealthCobbAngle32 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function WatsonHealthCobbAngle32({ children, ...rest }) {
  ...
  WatsonHealthCobbAngle32.displayName = 'WatsonHealthCobbAngle32';
  WatsonHealthCobbAngle32.propTypes = {
  ...
  WatsonHealthCobbAngle32.defaultProps = {
    width: 32,
    height: 32,
    viewBox: '0 0 32 32',
