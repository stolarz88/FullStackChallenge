(function (global, factory) {
  ...
  (global.WatsonHealthCobbAngle20 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function WatsonHealthCobbAngle20({ children, ...rest }) {
  ...
  WatsonHealthCobbAngle20.displayName = 'WatsonHealthCobbAngle20';
  WatsonHealthCobbAngle20.propTypes = {
  ...
  WatsonHealthCobbAngle20.defaultProps = {
    width: 20,
    height: 20,
    viewBox: '0 0 32 32',
