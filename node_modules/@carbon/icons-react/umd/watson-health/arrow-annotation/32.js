(function (global, factory) {
  ...
  (global.WatsonHealthArrowAnnotation32 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function WatsonHealthArrowAnnotation32({ children, ...rest }) {
    return React.createElement(
      ...
      React.createElement('path', { d: 'M19 25h2v-7h3v-2h-8v2h3v7z' })
    );
  }

  WatsonHealthArrowAnnotation32.displayName = 'WatsonHealthArrowAnnotation32';
  WatsonHealthArrowAnnotation32.propTypes = {
  ...
  WatsonHealthArrowAnnotation32.defaultProps = {
    width: 32,
    height: 32,
    viewBox: '0 0 32 32',
