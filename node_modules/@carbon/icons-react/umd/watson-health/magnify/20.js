(function (global, factory) {
  ...
  (global.WatsonHealthMagnify20 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function WatsonHealthMagnify20({ children, ...rest }) {
  ...
  WatsonHealthMagnify20.displayName = 'WatsonHealthMagnify20';
  WatsonHealthMagnify20.propTypes = {
  ...
  WatsonHealthMagnify20.defaultProps = {
    width: 20,
    height: 20,
    viewBox: '0 0 32 32',
