(function (global, factory) {
  ...
  (global.WatsonHealthMagnify24 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function WatsonHealthMagnify24({ children, ...rest }) {
  ...
  WatsonHealthMagnify24.displayName = 'WatsonHealthMagnify24';
  WatsonHealthMagnify24.propTypes = {
  ...
  WatsonHealthMagnify24.defaultProps = {
    width: 24,
    height: 24,
    viewBox: '0 0 32 32',
