(function (global, factory) {
  ...
  (global.WatsonHealthWindowBase32 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function WatsonHealthWindowBase32({ children, ...rest }) {
  ...
  WatsonHealthWindowBase32.displayName = 'WatsonHealthWindowBase32';
  WatsonHealthWindowBase32.propTypes = {
  ...
  WatsonHealthWindowBase32.defaultProps = {
    width: 32,
    height: 32,
    viewBox: '0 0 32 32',
