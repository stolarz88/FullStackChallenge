(function (global, factory) {
  ...
  (global.WatsonHealthPetImageB32 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function WatsonHealthPetImageB32({ children, ...rest }) {
  ...
  WatsonHealthPetImageB32.displayName = 'WatsonHealthPetImageB32';
  WatsonHealthPetImageB32.propTypes = {
  ...
  WatsonHealthPetImageB32.defaultProps = {
    width: 32,
    height: 32,
    viewBox: '0 0 32 32',
