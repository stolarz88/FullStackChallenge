(function (global, factory) {
  ...
  (global.OpenPanelRight32 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function OpenPanelRight32({ children, ...rest }) {
  ...
  OpenPanelRight32.displayName = 'OpenPanelRight32';
  OpenPanelRight32.propTypes = {
