(function (global, factory) {
  ...
  (global.OpenPanelRight24 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function OpenPanelRight24({ children, ...rest }) {
  ...
  OpenPanelRight24.displayName = 'OpenPanelRight24';
  OpenPanelRight24.propTypes = {
