(function (global, factory) {
  ...
  (global.OpenPanelRight20 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function OpenPanelRight20({ children, ...rest }) {
  ...
  OpenPanelRight20.displayName = 'OpenPanelRight20';
  OpenPanelRight20.propTypes = {
