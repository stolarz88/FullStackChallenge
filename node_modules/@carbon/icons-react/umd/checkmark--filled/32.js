(function (global, factory) {
  ...
  (global.CheckmarkFilled32 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function CheckmarkFilled32({ children, ...rest }) {
    return React.createElement(
      ...
      React.createElement('path', {
        d:
          'M16 2a14 14 0 1 0 14 14A14 14 0 0 0 16 2zm-2 19.5l-5-5 1.59-1.5L14 18.35 21.41 11 23 12.58z',
      })
    );
  }

  CheckmarkFilled32.displayName = 'CheckmarkFilled32';
  CheckmarkFilled32.propTypes = {
  ...
  CheckmarkFilled32.defaultProps = {
    width: 32,
    height: 32,
    viewBox: '0 0 32 32',
