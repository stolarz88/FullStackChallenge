(function (global, factory) {
  ...
  (global.MobileAdd24 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function MobileAdd24({ children, ...rest }) {
    return React.createElement(
      ...
      React.createElement('path', { d: 'M21 15h-4v-4h-2v4h-4v2h4v4h2v-4h4z' })
    );
  }

  MobileAdd24.displayName = 'MobileAdd24';
  MobileAdd24.propTypes = {
