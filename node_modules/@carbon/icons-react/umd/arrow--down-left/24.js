(function (global, factory) {
  ...
  (global.ArrowDownLeft24 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function ArrowDownLeft24({ children, ...rest }) {
    return React.createElement(
      'svg',
      iconHelpers.getAttributes(rest),
      children,
      React.createElement('path', {
        d: 'M22 26v-2H9.41L26 7.41 24.59 6 8 22.59V10H6v16h16z',
      })
    );
  }

  ArrowDownLeft24.displayName = 'ArrowDownLeft24';
  ArrowDownLeft24.propTypes = {
