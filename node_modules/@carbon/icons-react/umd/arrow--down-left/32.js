(function (global, factory) {
  ...
  (global.ArrowDownLeft32 = factory(global.CarbonIconHelpers,global.PropTypes,global.React));
}(this, (function (iconHelpers,PropTypes,React) { 'use strict';

  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  React = React && React.hasOwnProperty('default') ? React['default'] : React;

  function ArrowDownLeft32({ children, ...rest }) {
  ...
  ArrowDownLeft32.displayName = 'ArrowDownLeft32';
  ArrowDownLeft32.propTypes = {
