<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-xip4vx49po8">Show modal</button>

<div data-modal id="modal-xip4vx49po8" class="bx--modal " role="dialog" aria-modal="true" aria-labelledby="modal-xip4vx49po8-label" aria-describedby="modal-xip4vx49po8-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-xip4vx49po8-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-xip4vx49po8-heading">Modal heading</p>
