<button class="bx--btn bx--btn--danger--primary" type="button" data-modal-target="#modal-vo42hispoys">Show modal</button>

<div data-modal id="modal-vo42hispoys" class="bx--modal bx--modal--danger" role="dialog" aria-modal="true" aria-labelledby="modal-vo42hispoys-label" aria-describedby="modal-vo42hispoys-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-vo42hispoys-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-vo42hispoys-heading">Modal heading</p>
