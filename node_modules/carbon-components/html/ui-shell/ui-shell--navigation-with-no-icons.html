<header class="bx--header" role="banner" aria-label="IBM Platform Name">
  ...
  <div class="bx--header__global">
    <button class="bx--header__action" aria-label="Action 1 " title="Action 1">
    ...
    <button class="bx--header__action" aria-label="Action 2 " title="Action 2">
      <svg width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true">
        <path d="M8.24 25.14L7 26.67a14 14 0 0 0 4.18 2.44l.68-1.88a12 12 0 0 1-3.62-2.09zm-4.05-7.07l-2 .35A13.89 13.89 0 0 0 3.86 23l1.73-1a11.9 11.9 0 0 1-1.4-3.93zm7.63-13.31l-.68-1.88A14 14 0 0 0 7 5.33l1.24 1.53a12 12 0 0 1 3.58-2.1zM5.59 10L3.86 9a13.89 13.89 0 0 0-1.64 4.54l2 .35A11.9 11.9 0 0 1 5.59 10zM16 2v2a12 12 0 0 1 0 24v2a14 14 0 0 0 0-28z" />
      </svg>
    </button>
    <button class="bx--header__action" aria-label="Action 3 " title="Action 3">
      <svg width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true">
        <path d="M8.24 25.14L7 26.67a14 14 0 0 0 4.18 2.44l.68-1.88a12 12 0 0 1-3.62-2.09zm-4.05-7.07l-2 .35A13.89 13.89 0 0 0 3.86 23l1.73-1a11.9 11.9 0 0 1-1.4-3.93zm7.63-13.31l-.68-1.88A14 14 0 0 0 7 5.33l1.24 1.53a12 12 0 0 1 3.58-2.1zM5.59 10L3.86 9a13.89 13.89 0 0 0-1.64 4.54l2 .35A11.9 11.9 0 0 1 5.59 10zM16 2v2a12 12 0 0 1 0 24v2a14 14 0 0 0 0-28z" />
      </svg>
    </button>
    <button class="bx--header__action" aria-label="Action 4 " title="Action 4">
      <svg width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true">
        <path d="M8.24 25.14L7 26.67a14 14 0 0 0 4.18 2.44l.68-1.88a12 12 0 0 1-3.62-2.09zm-4.05-7.07l-2 .35A13.89 13.89 0 0 0 3.86 23l1.73-1a11.9 11.9 0 0 1-1.4-3.93zm7.63-13.31l-.68-1.88A14 14 0 0 0 7 5.33l1.24 1.53a12 12 0 0 1 3.58-2.1zM5.59 10L3.86 9a13.89 13.89 0 0 0-1.64 4.54l2 .35A11.9 11.9 0 0 1 5.59 10zM16 2v2a12 12 0 0 1 0 24v2a14 14 0 0 0 0-28z" />
      </svg>
    </button>
...
<aside class="bx--side-nav" data-side-nav>
  ...
  </aside><div class="bx--navigation">
  <div class="bx--navigation-section">
    <ul class="bx--navigation-items">
        <li class="bx--navigation-item">
          <a class="bx--navigation-link" href="/component/ui-shell--platform-navigation-expanded">
            Item link
          </a>
        </li>
        <li class="bx--navigation-item">
          ...
          <div class="bx--navigation__category bx--navigation__category--expanded">
            ...
            <ul id="category-1-menu" class="bx--navigation__category-items" role="menu">
                <li class="bx--navigation__category-item">
                  <a class="bx--navigation-link" href="/component/ui-shell--platform-navigation-expanded" role="menuitem">
                    Nested link
                  </a>
                </li>
