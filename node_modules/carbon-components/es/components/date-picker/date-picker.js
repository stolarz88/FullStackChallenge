...
var _initialiseProps = function _initialiseProps() {
  ...
  this._handleBlur = function (event) {
    if (_this2.calendar) {
      ...
      if (!focusTo || !_this2.element.contains(focusTo) && (!_this2.calendar.calendarContainer || !_this2.calendar.calendarContainer.contains(focusTo))) {
  ...
  this._initDatePicker = function (type) {
    if (type === 'range') {
      ...
      _this2.element.appendChild(rangeInput);
