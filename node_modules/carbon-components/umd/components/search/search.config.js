(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['module', '../../globals/js/feature-flags', '../../globals/js/settings'], factory);
  } else if (typeof exports !== "undefined") {
    factory(module, require('../../globals/js/feature-flags'), require('../../globals/js/settings'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod, global.featureFlags, global.settings);
    global.searchConfig = mod.exports;
  }
})(this, function (module, _require, _require2) {
  'use strict';

  var componentsX = _require.componentsX;
  var prefix = _require2.prefix;
