  ...
  _createClass(DropdownV2, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(_downshift.default, {
        ...
        return _react.default.createElement(_ListBox.default, _extends({
        ...
        }, getLabelProps()), selectedItem ? _this2.itemToElement(selectedItem) : label), _react.default.createElement(_ListBox.default.MenuIcon, {
          isOpen: isOpen
          ...
          return _react.default.createElement(_ListBox.default.MenuItem, _extends({
            ...
            item: item,
            index: index
          })), _react.default.createElement(ItemToElement, _extends({
            key: itemToString(item)
          }, item)));
        })));
      });
