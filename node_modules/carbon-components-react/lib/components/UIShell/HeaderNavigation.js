...
function (_React$Component) {
  ...
  _createClass(HeaderNavigation, [{
    ...
    value: function render() {
      ...
      var className = (0, _classnames.default)(_classNames.navigation.navigation, customClassName); // Assign both label strategies in this option, only one should be defined
      ...
      return _react.default.createElement("nav", _extends({}, rest, accessibilityLabel, {
        ...
        className: _classNames.navigation.menubar,
        role: "menubar",
...
_defineProperty(HeaderNavigation, "propTypes", _objectSpread({}, (0, _isRequiredOneOf.default)({
