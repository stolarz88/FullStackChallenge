...
var HeaderGlobalAction = function HeaderGlobalAction(_ref) {
  ...
  var className = (0, _classnames.default)(_classNames.action.action, customClassName, _defineProperty({}, _classNames.action.state.active, isActive));
...
HeaderGlobalAction.propTypes = _objectSpread({}, (0, _isRequiredOneOf.default)({
