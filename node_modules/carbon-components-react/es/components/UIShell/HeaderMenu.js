...
function (_React$Component) {
  ...
  _createClass(HeaderMenu, [{
    ...
    value: function render() {
      ...
      var className = cx(navigation.submenu, customClassName); // Notes on eslint comments and based on the examples in:
      ...
      return React.createElement("li", {
        ...
        className: navigation.menuarrow
...
_defineProperty(HeaderMenu, "propTypes", _objectSpread({}, isRequiredOneOf({
