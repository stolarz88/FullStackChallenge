...
function (_React$Component) {
  ...
  _createClass(HeaderNavigation, [{
    ...
    value: function render() {
      ...
      var className = cx(navigation.navigation, customClassName); // Assign both label strategies in this option, only one should be defined
...
_defineProperty(HeaderNavigation, "propTypes", _objectSpread({}, isRequiredOneOf({
